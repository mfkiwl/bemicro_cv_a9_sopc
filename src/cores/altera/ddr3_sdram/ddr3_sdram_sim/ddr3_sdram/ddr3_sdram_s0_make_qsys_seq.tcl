...
lappend arg_list "--component-param=SEQ_ROM=ddr3_sdram_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=ddr3_sdram_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=ddr3_sdram_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SEQUENCER_MEM_SIZE=12288"
...
lappend arg_list "--component-param=AVL_CLK_PS=16667"
lappend arg_list "--component-param=AFI_CLK_PS=3333"
...
lappend arg_list "--output-name=ddr3_sdram_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:ddr3_sdram_s0.sopcinfo"
lappend arg_list "--report-file=txt:ddr3_sdram_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=SIM_VERILOG"
catch { eval [concat [list exec "C:/altera/15.0/quartus//sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
