...
#############################################################
proc ddr3_sdram_p0_perform_flexible_write_launch_timing_analysis {opcs opcname inst family scale_factors_name interface_type max_package_skew dll_length period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
	...
	set msg_list [ list ]
	set dqs_pll_clock_id [ddr3_sdram_p0_get_output_clock_id $pins(dqs_pins) "DQS output" msg_list]
	...
	set msg_list [ list ]
	set dq_pll_clock_id [ddr3_sdram_p0_get_output_clock_id [ join [ join $pins(q_groups) ]] "DQ output" msg_list]
	...
	set pll_max [ddr3_sdram_p0_min_in_collection [get_path -rise_from ${pll_clock}|vco*ph[0] -rise_to ${pll_clock}|divclk] "arrival_time"]
	set pll_min [ddr3_sdram_p0_min_in_collection [get_path -rise_from ${pll_clock}|vco*ph[0] -rise_to ${pll_clock}|divclk -min_path] "arrival_time"]
	...
	if {($result == 1)} {
		...
		foreach dqpins $pins(q_groups) {
			...
			set msg_list [list]
			set leveling_delay_chain_name [ddr3_sdram_p0_traverse_to_leveling_delay_chain $dqspin msg_list]

			set dqs_periphery_node ${leveling_delay_chain_name}|clkin
			
			set cps_name [ddr3_sdram_p0_traverse_to_clock_phase_select $dqspin msg_list]
			...
			set DQSmin_of_max [ddr3_sdram_p0_min_in_collection $DQSpaths_max "arrival_time"]
			set DQSmax_of_min [ddr3_sdram_p0_max_in_collection $DQSpaths_min "arrival_time"]
			set DQSmax_of_max [ddr3_sdram_p0_max_in_collection $DQSpaths_max "arrival_time"]
			set DQSmin_of_min [ddr3_sdram_p0_min_in_collection $DQSpaths_min "arrival_time"]
			...
			set DQSperiphery_min_delay [ddr3_sdram_p0_min_in_collection $DQSperiphery_min "arrival_time"]
			set DQSperiphery_max_delay [ddr3_sdram_p0_max_in_collection $DQSperiphery_max "arrival_time"]
			set aiot_delay [ddr3_sdram_p0_round_3dp [expr [ddr3_sdram_p0_get_rise_aiot_delay $dqspin] * 1e9]]
			...
			foreach dqpin $dqdmpins {
				...
				# Perform the default timing analysis to get required and arrival times
				set pin_setup_slack [ddr3_sdram_p0_min_in_collection_to_name $paths_setup "slack" $dqpin]
				set pin_hold_slack  [ddr3_sdram_p0_min_in_collection_to_name $paths_hold "slack" $dqpin]
				...
				set msg_list [list]
				set leveling_delay_chain_name [ddr3_sdram_p0_traverse_to_leveling_delay_chain $dqpin msg_list]
				
				set dq_periphery_node ${leveling_delay_chain_name}|clkin

				set cps_name [ddr3_sdram_p0_traverse_to_clock_phase_select $dqpin msg_list]
				...
				set DQmin_of_max [ddr3_sdram_p0_min_in_collection $DQpaths_max "arrival_time"]
				set DQmax_of_min [ddr3_sdram_p0_max_in_collection $DQpaths_min "arrival_time"]
				set DQmax_of_max [ddr3_sdram_p0_max_in_collection $DQpaths_max "arrival_time"]
				set DQmin_of_min [ddr3_sdram_p0_min_in_collection $DQpaths_min "arrival_time"]
				...
				set DQperiphery_min_delay [ddr3_sdram_p0_min_in_collection $DQperiphery_min "arrival_time"]
				set DQperiphery_max_delay [ddr3_sdram_p0_max_in_collection $DQperiphery_max "arrival_time"]
				set aiot_delay [ddr3_sdram_p0_round_3dp [expr [ddr3_sdram_p0_get_rise_aiot_delay $dqpin] * 1e9]]
	...
	if {$IP(write_deskew_mode) == "dynamic"} {
		lappend wr_summary [list "  Before Calibration Write" [ddr3_sdram_p0_format_3dp $default_setup_slack] [ddr3_sdram_p0_format_3dp $default_hold_slack]]
	} else {
		lappend wr_summary [list "  Standard Write" [ddr3_sdram_p0_format_3dp $default_setup_slack] [ddr3_sdram_p0_format_3dp $default_hold_slack]]
	}
	
	if {($IP(write_deskew_mode) == "dynamic") && ($IP(mp_calibration) == 1) && ($IP(num_ranks) == 1)} {
		lappend wr_summary [list "  Memory Calibration" [ddr3_sdram_p0_format_3dp $mp_setup_slack] [ddr3_sdram_p0_format_3dp $mp_hold_slack]]
	}		
	...
	if {$IP(write_deskew_mode) == "dynamic"} {
		...
		set extra_shift [expr $board(intra_DQS_group_skew) + [ddr3_sdram_p0_round_3dp [expr (1.0-$t9_vt_variation_percent)*$t(WL_PSE)]]]
		...
		lappend wr_summary [list "  Deskew Write and/or more clock pessimism removal" [ddr3_sdram_p0_format_3dp $deskew_setup] [ddr3_sdram_p0_format_3dp $deskew_hold]]
		...
		lappend wr_summary [list "  Quantization error" [ddr3_sdram_p0_format_3dp [expr 0-$t9_quantization]] [ddr3_sdram_p0_format_3dp [expr 0-$t9_quantization]]]
		...
		lappend wr_summary [list "  Calibration uncertainty" [ddr3_sdram_p0_format_3dp [expr 0-$t9_variation]] [ddr3_sdram_p0_format_3dp [expr 0-$t9_variation]]] 
		...
		lappend wr_summary [list "  Spatial correlation pessimism removal" [ddr3_sdram_p0_format_3dp $pessimism_setup] [ddr3_sdram_p0_format_3dp $pessimism_hold]]
	...
	if {($IP(write_dcc) == "dynamic")} {
		...
		lappend wr_summary [list "  Duty cycle correction quantization error" [ddr3_sdram_p0_format_3dp [expr 0-$DCC_quantization]] [ddr3_sdram_p0_format_3dp [expr 0-$DCC_quantization]]]
		...
		lappend wr_summary [list "  Duty cycle correction calibration uncertainity" [ddr3_sdram_p0_format_3dp [expr 0-$dcc_variation]] [ddr3_sdram_p0_format_3dp [expr 0-$dcc_variation]]]
	}
	...
	if {($IP(write_deskew_mode) == "dynamic")} {
		set fcolour [ddr3_sdram_p0_get_colours $setup_slack $hold_slack]
		add_row_to_table -id $panel_id [list "After Calibration Write" [ddr3_sdram_p0_format_3dp $setup_slack] [ddr3_sdram_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Write ($opcname)" $setup_slack $hold_slack]
	} else {
		set fcolour [ddr3_sdram_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "Write" [ddr3_sdram_p0_format_3dp $setup_slack] [ddr3_sdram_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Write ($opcname)" [ddr3_sdram_p0_format_3dp $setup_slack] [ddr3_sdram_p0_format_3dp $hold_slack]]
	}
	...
	if {[string equal -nocase $uncertainty_reporting on]} {
		...
		add_row_to_table -id $panel_id [list "  FPGA uncertainty" [ddr3_sdram_p0_format_3dp $t(wru_fpga_uncertainty_s)] [ddr3_sdram_p0_format_3dp $t(wru_fpga_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "  External uncertainty" [ddr3_sdram_p0_format_3dp $t(wru_extl_uncertainty_s)] [ddr3_sdram_p0_format_3dp $t(wru_extl_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "Deskew" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA deskew" [ddr3_sdram_p0_format_3dp $t(wru_fpga_deskew_s)] [ddr3_sdram_p0_format_3dp $t(wru_fpga_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  External deskew" [ddr3_sdram_p0_format_3dp $t(wru_external_deskew_s)] [ddr3_sdram_p0_format_3dp $t(wru_external_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  Calibration uncertainty/error" [ddr3_sdram_p0_format_3dp $t(wru_calibration_uncertaintyerror_s)] [ddr3_sdram_p0_format_3dp $t(wru_calibration_uncertaintyerror_h)]] 
	}		
}
...
#############################################################
proc ddr3_sdram_p0_perform_flexible_read_capture_timing_analysis {opcs opcname inst family scale_factors_name io_std interface_type max_package_skew dqs_phase period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name} {
	...
	set fpga(tDQS_PSERR) [ expr [ get_integer_node_delay -integer $::GLOBAL_ddr3_sdram_p0_dqs_delay_chain_length -parameters {IO MAX HIGH} -src DQS_PSERR -in_fitter ] / 1000.0 ]
	...
	if {($result == 1)} {
		...
		foreach qpins $pins(q_groups) {
			...
			foreach qpin $qpins {
				...
				# Perform the default timing analysis to get required and arrival times
				set pin_setup_slack [ddr3_sdram_p0_min_in_collection_from_name $paths_setup "slack" $qpin]
				set pin_hold_slack  [ddr3_sdram_p0_min_in_collection_from_name $paths_hold "slack" $qpin]
	...
	set fcolour [ddr3_sdram_p0_get_colours $default_setup_slack $default_hold_slack]
	if {$IP(read_deskew_mode) == "dynamic"} {
		lappend rc_summary [list "  Before Calibration Read Capture" [ddr3_sdram_p0_format_3dp $default_setup_slack] [ddr3_sdram_p0_format_3dp $default_hold_slack]]
	} else {
		lappend rc_summary [list "  Standard Read Capture" [ddr3_sdram_p0_format_3dp $default_setup_slack] [ddr3_sdram_p0_format_3dp $default_hold_slack]] 
	}
	
	if {($IP(read_deskew_mode) == "dynamic") && ($IP(mp_calibration) == 1) && ($IP(num_ranks) == 1)} {
		lappend rc_summary [list "  Memory Calibration" [ddr3_sdram_p0_format_3dp $mp_setup_slack] [ddr3_sdram_p0_format_3dp $mp_hold_slack]] 
	}
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		...
		set extra_shift [expr $board(intra_DQS_group_skew) + [ddr3_sdram_p0_round_3dp [expr (1.0-$t1_vt_variation_percent)*$fpga(tDQS_PSERR)]]]
		...
		set deskew_setup [expr $setup_slack - $default_setup_slack - $mp_setup_slack]
		set deskew_hold  [expr $hold_slack - $default_hold_slack - $mp_hold_slack]
		lappend rc_summary [list "  Deskew Read" [ddr3_sdram_p0_format_3dp $deskew_setup] [ddr3_sdram_p0_format_3dp $deskew_hold]]
		...
		lappend rc_summary [list "  Quantization error" [ddr3_sdram_p0_format_3dp [expr 0-$t1_quantization]] [ddr3_sdram_p0_format_3dp [expr 0-$t1_quantization]]]
		
		# Consider variation in the delay chains used during dynamic deksew
		set dqs_period [ ddr3_sdram_p0_get_dqs_period $pins(dqs_pins) ]
		set offset_from_90 [ddr3_sdram_p0_get_acv_read_offset $period $dqs_phase $dqs_period]
		if {$IP(num_ranks) == 1} {
		...
		lappend rc_summary [list "  Calibration uncertainty" [ddr3_sdram_p0_format_3dp [expr 0-$t1_variation]] [ddr3_sdram_p0_format_3dp [expr 0-$t1_variation]]]
		...
		set pessimism_setup [expr $setup_slack - $default_setup_slack - $mp_setup_slack]
		set pessimism_hold  [expr $hold_slack - $default_hold_slack - $mp_hold_slack]
		lappend rc_summary [list "  Spatial correlation pessimism removal" [ddr3_sdram_p0_format_3dp $pessimism_setup] [ddr3_sdram_p0_format_3dp $pessimism_hold]] 
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		set fcolour [ddr3_sdram_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "After Calibration Read Capture" [ddr3_sdram_p0_format_3dp $setup_slack] [ddr3_sdram_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Read Capture ($opcname)" $setup_slack $hold_slack]
	} else {
		set fcolour [ddr3_sdram_p0_get_colours $setup_slack $hold_slack] 
		add_row_to_table -id $panel_id [list "Read Capture" [ddr3_sdram_p0_format_3dp $setup_slack] [ddr3_sdram_p0_format_3dp $hold_slack]] -fcolor $fcolour
		lappend summary [list $opcname 0 "Read Capture ($opcname)" $setup_slack $hold_slack]  
	}	
	...
	if {[string equal -nocase $uncertainty_reporting on]} {
		...
		add_row_to_table -id $panel_id [list "Value" "Setup Side" "Hold Side"]
		add_row_to_table -id $panel_id [list "Uncertainty" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA uncertainty" [ddr3_sdram_p0_format_3dp $t(rdu_fpga_uncertainty_s)] [ddr3_sdram_p0_format_3dp $t(rdu_fpga_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "  External uncertainty" [ddr3_sdram_p0_format_3dp $t(rdu_extl_uncertainty_s)] [ddr3_sdram_p0_format_3dp $t(rdu_extl_uncertainty_h)]] 
		add_row_to_table -id $panel_id [list "Deskew" "" ""]
		add_row_to_table -id $panel_id [list "  FPGA deskew" [ddr3_sdram_p0_format_3dp $t(rdu_fpga_deskew_s)] [ddr3_sdram_p0_format_3dp $t(rdu_fpga_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  External deskew" [ddr3_sdram_p0_format_3dp $t(rdu_external_deskew_s)] [ddr3_sdram_p0_format_3dp $t(rdu_external_deskew_h)]] 
		add_row_to_table -id $panel_id [list "  Calibration uncertainty/error" [ddr3_sdram_p0_format_3dp $t(rdu_calibration_uncertaintyerror_s)] [ddr3_sdram_p0_format_3dp $t(rdu_calibration_uncertaintyerror_h)]] 
	}
}
...
proc ddr3_sdram_p0_perform_phy_analyses {opcs opcname inst inst_controller pin_array_name timing_parameters_array_name summary_name IP_name} {
...
proc ddr3_sdram_p0_perform_ac_analyses {opcs opcname inst scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
	...
	foreach ck_pin $pins(ck_pins) {
		set clk_clk_phase_select_node [ddr3_sdram_p0_traverse_to_clock_phase_select $ck_pin msg_list]
	...
	set clk_max [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $clk_periphery_nodes] "arrival_time"]
	if {$clk_max <= 0} {set clk_max -9999}
	set clk_min [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $clk_periphery_nodes -min_path] "arrival_time"]
	...
	set CKperiphery_min_delay [ddr3_sdram_p0_min_in_collection $CKperiphery_min "arrival_time"]
	set CKperiphery_max_delay [ddr3_sdram_p0_max_in_collection $CKperiphery_max "arrival_time"]
	set aiot_delay [ddr3_sdram_p0_round_3dp [expr [ddr3_sdram_p0_get_rise_aiot_delay [lindex $pins(ck_pins) 0]] * 1e9]]
	...
	foreach ac_pin $ac_pins {
		...
		set pin_setup_slack [ddr3_sdram_p0_min_in_collection_to_name $paths_setup "slack" $ac_pin]
		set pin_hold_slack  [ddr3_sdram_p0_min_in_collection_to_name $paths_hold  "slack" $ac_pin]
		set current_ccpr    [ddr3_sdram_p0_min_in_collection_to_name $paths_hold  "ccpp" $ac_pin]
		
		set ac_clk_phase_select_node [ddr3_sdram_p0_traverse_to_clock_phase_select $ac_pin msg_list]
		set ac_periphery_node ${ac_clk_phase_select_node}|clkout 

		set ac_max  [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pll_clock -${rise_or_fall_to} $ac_periphery_node] "arrival_time"]
		if {$ac_max <= 0} {set ac_max -9999}
		set ac_min  [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pll_clock -${rise_or_fall_to} $ac_periphery_node -min_path] "arrival_time"]
		if {$ac_min <= 0} {set ac_min 9999}
		set extra_ccpr [ddr3_sdram_p0_round_3dp [expr ($clk_max - $clk_min + $ac_max - $ac_min)/2.0]]
		...
		set ACperiphery_min_delay [ddr3_sdram_p0_min_in_collection $ACperiphery_min "arrival_time"]
		set ACperiphery_max_delay [ddr3_sdram_p0_max_in_collection $ACperiphery_max "arrival_time"]
		set aiot_delay [ddr3_sdram_p0_round_3dp [expr [ddr3_sdram_p0_get_rise_aiot_delay [lindex $ac_pin 0]] * 1e9]]
	...
	set ac_summary [list]
	lappend ac_summary [list "  Standard Address Command" [ddr3_sdram_p0_format_3dp $default_setup_slack] [ddr3_sdram_p0_format_3dp $default_hold_slack]]
	lappend ac_summary [list "  Extra common clock and spatial correlation pessimism removal" [ddr3_sdram_p0_format_3dp [expr $setup_slack - $default_setup_slack]] [ddr3_sdram_p0_format_3dp [expr $hold_slack - $default_hold_slack]]]
	...
	set fcolour [ddr3_sdram_p0_get_colours $setup_slack $hold_slack] 
	add_row_to_table -id $panel_id [list "Address Command" [ddr3_sdram_p0_format_3dp $setup_slack] [ddr3_sdram_p0_format_3dp $hold_slack]] -fcolor $fcolour
	lappend summary [list $opcname 0 "Address Command ($opcname)" [ddr3_sdram_p0_format_3dp $setup_slack] [ddr3_sdram_p0_format_3dp $hold_slack]]
	...
	foreach dqs_pin $pins(dqs_pins) {
		...
		set dqs_pin_setup_slack [ddr3_sdram_p0_min_in_collection_to_name $dqs_paths_setup "slack" $dqs_pin]
		set dqs_pin_hold_slack  [ddr3_sdram_p0_min_in_collection_to_name $dqs_paths_hold  "slack" $dqs_pin]
		
		set dqs_clk_phase_select_node [ddr3_sdram_p0_traverse_to_clock_phase_select $dqs_pin msg_list]
		set dqs_periphery_node ${dqs_clk_phase_select_node}|clkout 

		set dqs_max  [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $dqs_periphery_node] "arrival_time"]
		if {$dqs_max <= 0} {set dqs_max -9999}
		set dqs_min  [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $dqs_periphery_node -min_path] "arrival_time"]
		if {$dqs_min <= 0} {set dqs_min 9999}

		set extra_ccpr [ddr3_sdram_p0_round_3dp [expr ($clk_max - $clk_min + $dqs_max - $dqs_min)/2.0]]
	...
	lappend dqs_summary [list "  Standard DQS vs CK" [ddr3_sdram_p0_format_3dp $default_dqs_setup_slack] [ddr3_sdram_p0_format_3dp $default_dqs_hold_slack]]
	lappend dqs_summary [list "  Extra common clock pessimism removal" [ddr3_sdram_p0_format_3dp [expr $dqs_setup_slack - $default_dqs_setup_slack]] [ddr3_sdram_p0_format_3dp [expr $dqs_hold_slack - $default_dqs_hold_slack]]]
	...
	set fcolour [ddr3_sdram_p0_get_colours $dqs_setup_slack $dqs_hold_slack] 
	add_row_to_table -id $dqs_panel_id [list "DQS vs CK" [ddr3_sdram_p0_format_3dp $dqs_setup_slack] [ddr3_sdram_p0_format_3dp $dqs_hold_slack]] -fcolor $fcolour
	lappend summary [list $opcname 0 "DQS vs CK ($opcname)" [ddr3_sdram_p0_format_3dp $dqs_setup_slack] [ddr3_sdram_p0_format_3dp $dqs_hold_slack]]
...
proc ddr3_sdram_p0_perform_flexible_bus_turnaround_time_analysis {opcs opcname instname family period dll_length interface_type tJITper tJITdty tDCD pll_steps pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set max_dly [expr [ddr3_sdram_p0_max_in_collection $ac_hold "clock_skew"]]
	...
	set min_dly [expr [ddr3_sdram_p0_min_in_collection $ac_setup "clock_skew"]]
...
proc ddr3_sdram_p0_perform_resync_timing_analysis {opcs opcname inst fbasename family scale_factors_name io_std interface_type period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name SSN_name} {
	...
	set max_dqs_common_to_fifo [ddr3_sdram_p0_max_in_collection [get_path -from $dqs_pins -to $fifo -nworst 1] "arrival_time"]
...
proc ddr3_sdram_p0_perform_flexible_postamble_timing_analysis {opcs opcname instname scale_factors_name family period dll_length interface_type tJITper tJITdty tDCD DQSpathjitter pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set mem_clock_delay_max [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $pins(ck_pins)] "arrival_time"]
	set mem_clock_delay_min [ddr3_sdram_p0_min_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $pins(ck_pins) -min_path] "arrival_time"]


	set dqs_delay_max  [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pins(dqs_pins) -fall_to *POSTAMBLE_DFF] "arrival_time"]
	set dqs_delay_min  [ddr3_sdram_p0_min_in_collection [get_path -rise_from $pins(dqs_pins) -fall_to *POSTAMBLE_DFF -min_path] "arrival_time"]	
	set ck_pin_buffer_delay [ddr3_sdram_p0_round_3dp [expr [ddr3_sdram_p0_get_min_aiot_delay [lindex $pins(ck_pins) 0]] * 1e9]]
	...
	set clock_delay_max [ddr3_sdram_p0_max_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $dqsenableextend_regs] "arrival_time"]
	set clock_delay_min [ddr3_sdram_p0_min_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $dqsenableextend_regs -min_path] "arrival_time"]
	set t11_delay_max [ddr3_sdram_p0_max_in_collection [get_path -rise_from $dqsenableextend_regs -fall_to *POSTAMBLE_DFF] "arrival_time"]
	set t11_delay_min [ddr3_sdram_p0_min_in_collection [get_path -rise_from $dqsenableextend_regs -fall_to *POSTAMBLE_DFF -min_path] "arrival_time"]
